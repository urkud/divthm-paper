...
\autoref{sec:GP-impl} I discuss some design choices I made in this
...
complex analysis. \autoref{sec:future-plans} is devoted to my
future plans.
...
\(y\to 0\). Clearly, a Fréchet differentiable function \(f\ \)has all partial
...
There are several generalizations of the Henstock-Kurzweil integral such that
...
\begin{theorem}%
  ...
  topology\footnote{This is a technical assumption required because of
    the way the Bochner integral is defined in mathlib.}. Let
