...
formalization of the Green's theorem for any elementary region in
Isabelle~\cite{TODO}. Neither of these two theorems implies the
other. Here are the key points where one of the formalizations is more
general than the other, see also \autoref{sec:gener-diverg-theor}.
