...
discuss some design choices I made in this project, both good and bad
ones. Finally, in \autoref{sec:appl-compl-analys} I explain how to
apply this theorem to prove the Cauchy-Goursat theorem and some other
basic theorems from complex analysis. \autoref{sec:future-plans} is
devoted to my future plans.
...
two boxes is their intersection and the join of two boxes is the
...
\(r\colon \bbR^{n} → (0, \infty)\) be a function such that for any
